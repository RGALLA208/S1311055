 ...
 : AudioProcessorEditor (&p), processor (p), treeState(vts)
{
    ...
    // Resonance
    resonanceValue = std::make_unique<AudioProcessorValueTreeState::SliderAttachment>(treeState,
        "resonance", resonanceDial);
    ...
    // Drive
    driveValue = std::make_unique<AudioProcessorValueTreeState::SliderAttachment>(treeState,
        "drive", driveDial);
    ...
    // Mode Selection
    modeChoice = std::make_unique<AudioProcessorValueTreeState::ComboBoxAttachment>(treeState,
        "mode", modeSel);
